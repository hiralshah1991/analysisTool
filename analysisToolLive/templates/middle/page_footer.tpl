...
{/if}
{if $currentModule eq 'rateSchedule'}
{if $currentPage eq 'rateSchedule'}
...
<script src="assets/scripts/custom/form-wizard.js?{$smarty.now}"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<!-- BEGIN PAGE LEVEL PLUGINS -->
...
<!-- END PAGE LEVEL SCRIPTS -->
{/if}
{if $currentPage eq 'rateScheduleList'}
<!-- BEGIN PAGE LEVEL STYLES -->
...
{literal}
   jQuery(document).ready(function() {
	 	...
	 	$('.footer-inner').html(year+" &copy; Gridscape. All Rights Reserved.");    
   		App.init(); // initlayout and core plugins
   		Index.init();
{/literal}
	{if $currentModule eq 'rateSchedule' && $currentPage eq 'rateSchedule'}
{literal}
   		FormWizard.init();
   		ComponentsPickers.init();
{/literal}
	{/if}
	{if $currentModule eq 'rateSchedule' && $currentPage eq 'rateScheduleList'}
{literal}
	TableManaged.init();
{/literal}
	{/if}
