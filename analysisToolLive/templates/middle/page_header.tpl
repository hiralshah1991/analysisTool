	...
	<div class="page-sidebar-wrapper">
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu" data-auto-scroll="true" data-slide-speed="200">
				...
				<li class="{if $currentModule eq 'analysis'}active {/if}">
					<a href="javascript:;">
					...
					<ul class="sub-menu">
						...
						<li {if $currentPage eq 'newanalysis'}class="active"{/if}>
							<a href="analysisFontanaMonthlyFinal.php" >
								<i class="fa fa-plus-square-o"></i>
								New Analysis - Multiple Column
							</a>
						</li>
						<li {if $currentPage eq 'newanalysisvertical'}class="active"{/if}>
							<a href="analysisVertical.php" >
								<i class="fa fa-plus-square-o"></i>
								New Analysis - Single Column
							</a>
						</li>
					</ul>
				</li>
				<li {if $currentModule eq 'usageGeneration'}class="active"{/if}>
					<a href="javascript:;">
						<i class="fa fa-money"></i>
						<span class="title">
							Usage Data
						</span>
						<span class="arrow {if $currentModule eq 'usageGeneration'}open{/if}">
						</span>
						<span class="selected">
						</span>
					</a>
					<ul class="sub-menu">
						<li {if $currentPage eq 'usageGeneration'}class="active"{/if} >
							<a href="getUsageFile.php">
								<i class="fa fa-table"></i>
								Generate Usage Data
							</a>
						</li>
