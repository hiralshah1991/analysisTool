								...
								<div class="tab-pane" id="tab2">
									...
									<div class="row">
										<div class="form-group col-md-6">
											...
											<div id="form_error_s1_date_range"></div>
											</div>
										</div>
										<div class="form-group col-md-6">
											...
											<label class="control-label col-md-3">On Peak Time Range</label>
												...
												{if $clsRateSchedule->s1_usage_time_range_weekdays.onpeak.from|@count gt 0}
													...
													{section name=i start=0 loop=$fromCnt step=1}
														...
														<div data-rownum="{$id}">
                                                        	...
                                                        	<div class="col-md-1">
                                                        		<span name="add_{$id}" data-name="s1_usage_time_range_weekdays" data-tp="onpeak"><i class="fa fa-plus"></i></span>
                                                        		<span name="remove_{$id}" style="display:none"><i class="fa fa-plus"></i></span>
                                                        	</div>
												...
												{else}
													<div data-rownum="0">
														...
														<div class="col-md-1">
    														<span name="add_0" data-name="s1_usage_time_range_weekdays" data-tp="onpeak"><i class="fa fa-plus"></i></span>
											...
											Time Range</label>
												...
												{if $clsRateSchedule->s1_usage_time_range_weekdays.offpeak.from|@count gt 0}
													...
													{section name=i start=0 loop=$fromCnt step=1}
														...
														<div data-rownum="{$id}">
                                                        	...
                                                        	<div class="col-md-1">
                                                        		<span name="add_{$id}" data-name="s1_usage_time_range_weekdays" data-tp="offpeak"><i class="fa fa-plus"></i></span>
                                                        		<span name="remove_{$id}" style="display:none"><i class="fa fa-plus"></i></span>
                                                        	</div>
												...
												{else}
													<div  data-rownum="0">
														...
														<div class="col-md-1">
    														<span name="add_0" data-name="s1_usage_time_range_weekdays" data-tp="offpeak"><i class="fa fa-plus"></i></span>
    														<span name="remove_0" style="display:none"><i class="fa fa-minus"></i></span>
    													</div>
											...
											Time Range</label>
												...
												{if $clsRateSchedule->s1_usage_time_range_weekdays.midpeak.from|@count gt 0}
													...
													{section name=i start=0 loop=$fromCnt step=1}
														...
														<div data-rownum="{$id}">
                                                        	...
                                                        	<div class="col-md-1">
                                                        		<span name="add_{$id}" data-name="s1_usage_time_range_weekdays" data-tp="midpeak"><i class="fa fa-plus"></i></span>
                                                        		<span name="remove_{$id}" style="display:none"><i class="fa fa-plus"></i></span>
                                                        	</div>
												...
												{else}
													<div  data-rownum="0">
														...
														<div class="col-md-1">
    														<span name="add_0" data-name="s1_usage_time_range_weekdays" data-tp="midpeak"><i class="fa fa-plus"></i></span>
    														<span name="remove_0" style="display:none"><i class="fa fa-minus"></i></span>
    													</div>
											...
											Time Range</label>
												...
												{if $clsRateSchedule->s1_usage_time_range_weekdays.partialpeak.from|@count gt 0}
													...
													{section name=i start=0 loop=$fromCnt step=1}
														...
														<div data-rownum="{$id}">
                                                        	...
                                                        	<div class="col-md-1">
                                                        		<span name="add_{$id}" data-name="s1_usage_time_range_weekdays" data-tp="partialpeak"><i class="fa fa-plus"></i></span>
                                                        		<span name="remove_{$id}" style="display:none"><i class="fa fa-plus"></i></span>
                                                        	</div>
												...
												{else}
													<div data-rownum="0">
														...
														<div class="col-md-1">
    														<span name="add_0" data-name="s1_usage_time_range_weekdays" data-tp="partialpeak"><i class="fa fa-plus"></i></span>
    														<span name="remove_0" style="display:none"><i class="fa fa-minus"></i></span>
    													</div>
											...
											<div class="col-md-9">
												{if $clsRateSchedule->s1_usage_time_range_weekdays.criticalpeak.from|@count gt 0}
													...
													{section name=i start=0 loop=$fromCnt step=1}
														...
														<div data-rownum="{$id}">
                                                        	...
                                                        	<div class="col-md-1">
                                                        		<span name="add_{$id}" data-name="s1_usage_time_range_weekdays" data-tp="criticalpeak"><i class="fa fa-plus"></i></span>
                                                        		<span name="remove_{$id}" style="display:none"><i class="fa fa-plus"></i></span>
                                                        	</div>
												...
												{else}
													<div  data-rownum="0">
														...
														<div class="col-md-1">
    														<span name="add_0" data-name="s1_usage_time_range_weekdays" data-tp="criticalpeak"><i class="fa fa-plus"></i></span>
    														<span name="remove_0" style="display:none"><i class="fa fa-minus"></i></span>
    													</div>
											...
											<div class="col-md-9">
												{if $clsRateSchedule->s1_usage_time_range_weekdays.superoffpeak.from|@count gt 0}
													...
													{section name=i start=0 loop=$fromCnt step=1}
														...
														<div data-rownum="{$id}">
                                                        	...
                                                        	<div class="col-md-1">
                                                        		<span name="add_{$id}" data-name="s1_usage_time_range_weekdays" data-tp="superoffpeak"><i class="fa fa-plus"></i></span>
                                                        		<span name="remove_{$id}" style="display:none"><i class="fa fa-plus"></i></span>
                                                        	</div>
												...
												{else}
													<div  data-rownum="0">
														...
														<div class="col-md-1">
    														<span name="add_0" data-name="s1_usage_time_range_weekdays" data-tp="superoffpeak"><i class="fa fa-plus"></i></span>
    														<span name="remove_0" style="display:none"><i class="fa fa-minus"></i></span>
    													</div>
											...
											<div class="col-md-9">
												{if $clsRateSchedule->s1_usage_time_range_weekend.onpeak.from|@count gt 0}
													...
													{section name=i start=0 loop=$fromCnt step=1}
														...
														<div data-rownum="{$id}">
                                                        	...
                                                        	<div class="col-md-1">
                                                        		<span name="add_{$id}" data-name="s1_usage_time_range_weekend" data-tp="onpeak"><i class="fa fa-plus"></i></span>
                                                        		<span name="remove_{$id}" style="display:none"><i class="fa fa-plus"></i></span>
                                                        	</div>
												...
												{else}
													<div  data-rownum="0">
														...
														<div class="col-md-1">
    														<span name="add_0" data-name="s1_usage_time_range_weekend" data-tp="onpeak"><i class="fa fa-plus"></i></span>
    														<span name="remove_0" style="display:none"><i class="fa fa-minus"></i></span>
    													</div>
											...
											<div class="col-md-9">
												{if $clsRateSchedule->s1_usage_time_range_weekend.offpeak.from|@count gt 0}
													...
													{section name=i start=0 loop=$fromCnt step=1}
														...
														<div data-rownum="{$id}">
                                                        	...
                                                        	<div class="col-md-1">
                                                        		<span name="add_{$id}" data-name="s1_usage_time_range_weekend" data-tp="offpeak"><i class="fa fa-plus"></i></span>
                                                        		<span name="remove_{$id}" style="display:none"><i class="fa fa-plus"></i></span>
                                                        	</div>
												...
												{else}
													<div  data-rownum="0">
														...
														<div class="col-md-1">
    														<span name="add_0" data-name="s1_usage_time_range_weekend" data-tp="offpeak"><i class="fa fa-plus"></i></span>
    														<span name="remove_0" style="display:none"><i class="fa fa-minus"></i></span>
    													</div>
											...
											<div class="col-md-9">
												{if $clsRateSchedule->s1_usage_time_range_weekend.midpeak.from|@count gt 0}
													...
													{section name=i start=0 loop=$fromCnt step=1}
														...
														<div data-rownum="{$id}">
                                                        	...
                                                        	<div class="col-md-1">
                                                        		<span name="add_{$id}" data-name="s1_usage_time_range_weekend" data-tp="midpeak"><i class="fa fa-plus"></i></span>
                                                        		<span name="remove_{$id}" style="display:none"><i class="fa fa-plus"></i></span>
                                                        	</div>
												...
												{else}
													<div  data-rownum="0">
														...
														<div class="col-md-1">
    														<span name="add_0" data-name="s1_usage_time_range_weekend" data-tp="midpeak"><i class="fa fa-plus"></i></span>
    														<span name="remove_0" style="display:none"><i class="fa fa-minus"></i></span>
    													</div>
											...
											<div class="col-md-9">
												{if $clsRateSchedule->s1_usage_time_range_weekend.partialpeak.from|@count gt 0}
													...
													{section name=i start=0 loop=$fromCnt step=1}
														...
														<div data-rownum="{$id}">
                                                        	...
                                                        	<div class="col-md-1">
                                                        		<span name="add_{$id}" data-name="s1_usage_time_range_weekend" data-tp="partialpeak"><i class="fa fa-plus"></i></span>
                                                        		<span name="remove_{$id}" style="display:none"><i class="fa fa-plus"></i></span>
                                                        	</div>
												...
												{else}
													<div  data-rownum="0">
														...
														<div class="col-md-1">
    														<span name="add_0" data-name="s1_usage_time_range_weekend" data-tp="partialpeak"><i class="fa fa-plus"></i></span>
    														<span name="remove_0" style="display:none"><i class="fa fa-minus"></i></span>
    													</div>
											...
											Time Range</label>
												...
												{if $clsRateSchedule->s1_usage_time_range_weekend.criticalpeak.from|@count gt 0}
													...
													{section name=i start=0 loop=$fromCnt step=1}
														...
														<div data-rownum="{$id}">
                                                        	...
                                                        	<div class="col-md-1">
                                                        		<span name="add_{$id}" data-name="s1_usage_time_range_weekend" data-tp="criticalpeak"><i class="fa fa-plus"></i></span>
                                                        		<span name="remove_{$id}" style="display:none"><i class="fa fa-plus"></i></span>
                                                        	</div>
												...
												{else}
													<div  data-rownum="0">
														...
														<div class="col-md-1">
    														<span name="add_0" data-name="s1_usage_time_range_weekend" data-tp="criticalpeak"><i class="fa fa-plus"></i></span>
    														<span name="remove_0" style="display:none"><i class="fa fa-minus"></i></span>
    													</div>
											...
											<div class="col-md-9">
												{if $clsRateSchedule->s1_usage_time_range_weekend.superoffpeak.from|@count gt 0}
													...
													{section name=i start=0 loop=$fromCnt step=1}
														...
														<div data-rownum="{$id}">
                                                        	...
                                                        	<div class="col-md-1">
                                                        		<span name="add_{$id}" data-name="s1_usage_time_range_weekend" data-tp="superoffpeak"><i class="fa fa-plus"></i></span>
                                                        		<span name="remove_{$id}" style="display:none"><i class="fa fa-plus"></i></span>
                                                        	</div>
												...
												{else}
													<div  data-rownum="0">
														...
														<div class="col-md-1">
    														<span name="add_0" data-name="s1_usage_time_range_weekend" data-tp="superoffpeak"><i class="fa fa-plus"></i></span>
    														<span name="remove_0" style="display:none"><i class="fa fa-minus"></i></span>
    													</div>
											...
											<label class="control-label col-md-3">On Peak Time Range</label>
												...
												{if $clsRateSchedule->s2_usage_time_range_weekdays.onpeak.from|@count gt 0}
													...
													{section name=i start=0 loop=$fromCnt step=1}
														...
														<div data-rownum="{$id}">
                                                        	...
                                                        	<div class="col-md-1">
                                                        		<span name="add_{$id}" data-name="s2_usage_time_range_weekdays" data-tp="onpeak"><i class="fa fa-plus"></i></span>
                                                        		<span name="remove_{$id}" style="display:none"><i class="fa fa-plus"></i></span>
                                                        	</div>
												...
												{else}
													<div  data-rownum="0">
														...
														<div class="col-md-1">
    														<span name="add_0" data-name="s2_usage_time_range_weekdays" data-tp="onpeak"><i class="fa fa-plus"></i></span>
    														<span name="remove_0" style="display:none"><i class="fa fa-minus"></i></span>
    													</div>
											...
											Time Range</label>
												...
												{if $clsRateSchedule->s2_usage_time_range_weekdays.offpeak.from|@count gt 0}
													...
													{section name=i start=0 loop=$fromCnt step=1}
														...
														<div data-rownum="{$id}">
                                                        	...
                                                        	<div class="col-md-1">
                                                        		<span name="add_{$id}" data-name="s2_usage_time_range_weekdays" data-tp="offpeak"><i class="fa fa-plus"></i></span>
                                                        		<span name="remove_{$id}" style="display:none"><i class="fa fa-plus"></i></span>
                                                        	</div>
												...
												{else}
													<div  data-rownum="0">
														...
														<div class="col-md-1">
    														<span name="add_0" data-name="s2_usage_time_range_weekdays" data-tp="offpeak"><i class="fa fa-plus"></i></span>
    														<span name="remove_0" style="display:none"><i class="fa fa-minus"></i></span>
    													</div>
											...
											Time Range</label>
												...
												{if $clsRateSchedule->s2_usage_time_range_weekdays.midpeak.from|@count gt 0}
													...
													{section name=i start=0 loop=$fromCnt step=1}
														...
														<div data-rownum="{$id}">
                                                        	...
                                                        	<div class="col-md-1">
                                                        		<span name="add_{$id}" data-name="s2_usage_time_range_weekdays" data-tp="midpeak"><i class="fa fa-plus"></i></span>
                                                        		<span name="remove_{$id}" style="display:none"><i class="fa fa-plus"></i></span>
                                                        	</div>
												...
												{else}
													<div  data-rownum="0">
														...
														<div class="col-md-1">
    														<span name="add_0" data-name="s2_usage_time_range_weekdays" data-tp="midpeak"><i class="fa fa-plus"></i></span>
    														<span name="remove_0" style="display:none"><i class="fa fa-minus"></i></span>
    													</div>
											...
											Time Range</label>
												...
												{if $clsRateSchedule->s2_usage_time_range_weekdays.partialpeak.from|@count gt 0}
													...
													{section name=i start=0 loop=$fromCnt step=1}
														...
														<div data-rownum="{$id}">
                                                        	...
                                                        	<div class="col-md-1">
                                                        		<span name="add_{$id}" data-name="s2_usage_time_range_weekdays" data-tp="partialpeak"><i class="fa fa-plus"></i></span>
                                                        		<span name="remove_{$id}" style="display:none"><i class="fa fa-plus"></i></span>
                                                        	</div>
												...
												{else}
													<div  data-rownum="0">
														...
														<div class="col-md-1">
    														<span name="add_0" data-name="s2_usage_time_range_weekdays" data-tp="partialpeak"><i class="fa fa-plus"></i></span>
    														<span name="remove_0" style="display:none"><i class="fa fa-minus"></i></span>
    													</div>
											...
											<div class="col-md-9">
												{if $clsRateSchedule->s2_usage_time_range_weekdays.criticalpeak.from|@count gt 0}
													...
													{section name=i start=0 loop=$fromCnt step=1}
														...
														<div data-rownum="{$id}">
                                                        	...
                                                        	<div class="col-md-1">
                                                        		<span name="add_{$id}" data-name="s2_usage_time_range_weekdays" data-tp="criticalpeak"><i class="fa fa-plus"></i></span>
                                                        		<span name="remove_{$id}" style="display:none"><i class="fa fa-plus"></i></span>
                                                        	</div>
												...
												{else}
													<div  data-rownum="0">
														...
														<div class="col-md-1">
    														<span name="add_0" data-name="s2_usage_time_range_weekdays" data-tp="criticalpeak"><i class="fa fa-plus"></i></span>
    														<span name="remove_0" style="display:none"><i class="fa fa-minus"></i></span>
    													</div>
											...
											<div class="col-md-9">
												{if $clsRateSchedule->s2_usage_time_range_weekdays.superoffpeak.from|@count gt 0}
													...
													{section name=i start=0 loop=$fromCnt step=1}
														...
														<div data-rownum="{$id}">
                                                        	...
                                                        	<div class="col-md-1">
                                                        		<span name="add_{$id}" data-name="s2_usage_time_range_weekdays" data-tp="superoffpeak"><i class="fa fa-plus"></i></span>
                                                        		<span name="remove_{$id}" style="display:none"><i class="fa fa-plus"></i></span>
                                                        	</div>
												...
												{else}
													<div  data-rownum="0">
														...
														<div class="col-md-1">
    														<span name="add_0" data-name="s2_usage_time_range_weekdays" data-tp="superoffpeak"><i class="fa fa-plus"></i></span>
    														<span name="remove_0" style="display:none"><i class="fa fa-minus"></i></span>
    													</div>
											...
											<div class="col-md-9">
												{if $clsRateSchedule->s2_usage_time_range_weekend.onpeak.from|@count gt 0}
													...
													{section name=i start=0 loop=$fromCnt step=1}
														...
														<div data-rownum="{$id}">
                                                        	...
                                                        	<div class="col-md-1">
                                                        		<span name="add_{$id}" data-name="s2_usage_time_range_weekend" data-tp="onpeak"><i class="fa fa-plus"></i></span>
                                                        		<span name="remove_{$id}" style="display:none"><i class="fa fa-plus"></i></span>
                                                        	</div>
												...
												{else}
													<div  data-rownum="0">
														...
														<div class="col-md-1">
    														<span name="add_0" data-name="s2_usage_time_range_weekend" data-tp="onpeak"><i class="fa fa-plus"></i></span>
    														<span name="remove_0" style="display:none"><i class="fa fa-minus"></i></span>
    													</div>
											...
											<div class="col-md-9">
												{if $clsRateSchedule->s2_usage_time_range_weekend.offpeak.from|@count gt 0}
													...
													{section name=i start=0 loop=$fromCnt step=1}
														...
														<div data-rownum="{$id}">
                                                        	...
                                                        	<div class="col-md-1">
                                                        		<span name="add_{$id}" data-name="s2_usage_time_range_weekend" data-tp="offpeak"><i class="fa fa-plus"></i></span>
                                                        		<span name="remove_{$id}" style="display:none"><i class="fa fa-plus"></i></span>
                                                        	</div>
												...
												{else}
													<div  data-rownum="0">
														...
														<div class="col-md-1">
    														<span name="add_0" data-name="s2_usage_time_range_weekend" data-tp="offpeak"><i class="fa fa-plus"></i></span>
    														<span name="remove_0" style="display:none"><i class="fa fa-minus"></i></span>
    													</div>
											...
											<div class="col-md-9">
												{if $clsRateSchedule->s2_usage_time_range_weekend.midpeak.from|@count gt 0}
													...
													{section name=i start=0 loop=$fromCnt step=1}
														...
														<div data-rownum="{$id}">
                                                        	...
                                                        	<div class="col-md-1">
                                                        		<span name="add_{$id}" data-name="s2_usage_time_range_weekend" data-tp="midpeak"><i class="fa fa-plus"></i></span>
                                                        		<span name="remove_{$id}" style="display:none"><i class="fa fa-plus"></i></span>
                                                        	</div>
												...
												{else}
													<div  data-rownum="0">
														...
														<div class="col-md-1">
    														<span name="add_0" data-name="s2_usage_time_range_weekend" data-tp="midpeak"><i class="fa fa-plus"></i></span>
    														<span name="remove_0" style="display:none"><i class="fa fa-minus"></i></span>
    													</div>
											...
											<div class="col-md-9">
												{if $clsRateSchedule->s2_usage_time_range_weekend.partialpeak.from|@count gt 0}
													...
													{section name=i start=0 loop=$fromCnt step=1}
														...
														<div data-rownum="{$id}">
                                                        	...
                                                        	<div class="col-md-1">
                                                        		<span name="add_{$id}" data-name="s2_usage_time_range_weekend" data-tp="partialpeak"><i class="fa fa-plus"></i></span>
                                                        		<span name="remove_{$id}" style="display:none"><i class="fa fa-plus"></i></span>
                                                        	</div>
												...
												{else}
													<div  data-rownum="0">
														...
														<div class="col-md-1">
    														<span name="add_0" data-name="s2_usage_time_range_weekend" data-tp="partialpeak"><i class="fa fa-plus"></i></span>
    														<span name="remove_0" style="display:none"><i class="fa fa-minus"></i></span>
    													</div>
											...
											Time Range</label>
												...
												{if $clsRateSchedule->s2_usage_time_range_weekend.criticalpeak.from|@count gt 0}
													...
													{section name=i start=0 loop=$fromCnt step=1}
														...
														<div data-rownum="{$id}">
                                                        	...
                                                        	<div class="col-md-1">
                                                        		<span name="add_{$id}" data-name="s2_usage_time_range_weekend" data-tp="criticalpeak"><i class="fa fa-plus"></i></span>
                                                        		<span name="remove_{$id}" style="display:none"><i class="fa fa-plus"></i></span>
                                                        	</div>
												...
												{else}
													<div  data-rownum="0">
														...
														<div class="col-md-1">
    														<span name="add_0" data-name="s2_usage_time_range_weekend" data-tp="criticalpeak"><i class="fa fa-plus"></i></span>
    														<span name="remove_0" style="display:none"><i class="fa fa-minus"></i></span>
    													</div>
											...
											<div class="col-md-9">
												{if $clsRateSchedule->s2_usage_time_range_weekend.superoffpeak.from|@count gt 0}
													...
													{section name=i start=0 loop=$fromCnt step=1}
														...
														<div data-rownum="{$id}">
                                                        	...
                                                        	<div class="col-md-1">
                                                        		<span name="add_{$id}" data-name="s2_usage_time_range_weekend" data-tp="superoffpeak"><i class="fa fa-plus"></i></span>
                                                        		<span name="remove_{$id}" style="display:none"><i class="fa fa-plus"></i></span>
                                                        	</div>
												...
												{else}
													<div  data-rownum="0">
														...
														<div class="col-md-1">
    														<span name="add_0" data-name="s2_usage_time_range_weekend" data-tp="superoffpeak"><i class="fa fa-plus"></i></span>
    														<span name="remove_0" style="display:none"><i class="fa fa-minus"></i></span>
    													</div>
