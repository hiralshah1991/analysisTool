											...
											<label class="control-label col-md-3">On Peak Time Range</label>
												<div class="col-md-9">
													<div  data-rownum="0">
    													...
    													<div class="col-md-1">
    														<span  id="add_0" data-name="s1_usage_time_range_weekdays" data-tp="onpeak">+</span>
    														<span  id="remove_0" style="display:none">+</span>
    													</div>
											...
											Time Range</label>
												...
												<div class="col-md-9">
													...
													<div class="col-md-4">
														<div class="input-icon">
															<i class="fa fa-clock-o"></i>  
															<input type="text" class="form-control timepicker timepicker-24" name="s1_usage_time_range_weekend[onpeak][to][]" value="{if $clsRateSchedule->s1_usage_time_range_weekend.onpeak.to.0 neq ''}{$clsRateSchedule->s1_usage_time_range_weekend.onpeak.to.0}{else}N/A{/if}">
														</div>
													</div>
												</div>
										...
										<div class="col-md-6">
											...
											Time Range</label>
												...
												<div class="col-md-4">
													<div class="input-icon">
														<i class="fa fa-clock-o"></i>  
														<input type="text" class="form-control timepicker timepicker-24" name="s1_usage_time_range_weekend[offpeak][to]" >
													</div>
												</div>
										...
										<div class="col-md-6">
											...
											Time Range</label>
												...
												<div class="col-md-4">
													<div class="input-icon">
														<i class="fa fa-clock-o"></i>  
														<input type="text" class="form-control timepicker timepicker-24" name="s1_usage_time_range_weekend[midpeak][to]" >
													</div>
												</div>
										...
										<div class="col-md-6">
											...
											Time Range</label>
												...
												<div class="col-md-4">
													<div class="input-icon">
														<i class="fa fa-clock-o"></i>  
														<input type="text" class="form-control timepicker timepicker-24" name="s1_usage_time_range_weekend[partialpeak][to]" >
													</div>
												</div>
										</div>
									</div>
										...
										<div class="col-md-6">
											...
											Time Range</label>
												...
												<div class="col-md-4">
													<div class="input-icon">
														<i class="fa fa-clock-o"></i>  
														<input type="text" class="form-control timepicker timepicker-24" name="s1_usage_time_range_weekend[criticalpeak][to]" >
													</div>
												</div>
										...
										<div class="col-md-6">
											...
											Time Range</label>
												...
												<div class="col-md-4">
													<div class="input-icon">
														<i class="fa fa-clock-o"></i>  
														<input type="text" class="form-control timepicker timepicker-24" name="s1_usage_time_range_weekend[superoffpeak][to]" >
													</div>
												</div>
										</div>
									</div>
...
$(document).on('click','[id^=add_]',function(){
	var currentRowNumber = parseInt($(this).attr('id').split('_')[1]);
	if(nextRowNumber == ''){
	...
	//$('[id^=remove_'+currentRowNumber+']').show();
