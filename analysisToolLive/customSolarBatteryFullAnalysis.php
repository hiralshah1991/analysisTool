                        ...
                        foreach ($batterySizeArray as $batterySize) {
                            ...
                            foreach($arrToProcess as $k => $v) {
                                ...
                                if($totalDaysOFMonth == $day && $hour == 23.45){
                                    ...
                                    $lowerThresholdCount = 0;
                                    $upperThresholdCount = 0;
                                    $fullSummary[] = array($month,$day,$hour,$demand[$month][$day][$hour],$generation[$month][$day][$hour],$energyFromGrid[$month][$day][$hour],$BS[$month][$day][$hour],$energyExport[$month][$day][$hour],$SOC[$month][$day][$hour],$energyCharges[$month][$day][$hour],$criticalPeakCharges[$month][$day][$hour],$demandRatesPeak[$month]['onpeak']['peakValueKW'],$demandRatesPeak[$month]['offpeak']['peakValueKW'],$demandRatesPeak[$month]['partialpeak']['peakValueKW'],$demandCharges[$month]['onpeak'],$demandCharges[$month]['offpeak'],$demandCharges[$month]['partialpeak']);
                                    
                                }else{
                                    $fullSummary[] = array($month,$day,$hour,$demand[$month][$day][$hour],$generation[$month][$day][$hour],$energyFromGrid[$month][$day][$hour],$BS[$month][$day][$hour],$energyExport[$month][$day][$hour],$SOC[$month][$day][$hour],$energyCharges[$month][$day][$hour],$criticalPeakCharges[$month][$day][$hour],'-','-','-','-','-','-');
...
if(!empty($fullSummary)){
    ...
    fputcsv($output, array(
        ...
        'SOC (%)',
        'Energy Charges ($)',
        'CriticalPeak Charges ($)',
        'OnPeak Demand (KW)',
        'OffPeak Demand (KW)',
        'PartialPeak Demand (KW)',
        'OnPeak Demand Cost ($)',
        'OffPeak Demand Cost ($)',
        'PartialPeak Demand Cost ($)'
    ));
